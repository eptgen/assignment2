...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        imageio.imsave("out/voxel_pred.png", (rend1.detach().numpy()[0, ..., :3] * 255).astype(np.uint8))
        imageio.imsave("out/voxel_gt.png", (rend2.detach().numpy()[0, ..., :3] * 255).astype(np.uint8))
        ...
        imageio.imsave("out/pointcloud_pred.png", (rend1.detach().numpy()[0, ..., :3] * 255).astype(np.uint8))
        imageio.imsave("out/pointcloud_gt.png", (rend2.detach().numpy()[0, ..., :3] * 255).astype(np.uint8))
        ...
        imageio.imsave("out/mesh_pred.png", (rend1.detach().numpy()[0, ..., :3] * 255).astype(np.uint8))
        imageio.imsave("out/mesh_gt.png", (rend2.detach().numpy()[0, ..., :3] * 255).astype(np.uint8))
