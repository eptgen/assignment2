...
import torch
from utils import get_mesh_renderer, get_points_renderer, render_cloud, render_mesh, render_voxel
...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        rend1 = render_mesh(mesh_src, args)
        rend2 = render_mesh(mesh_tgt, args)
