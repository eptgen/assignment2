...
def evaluate_model(args):
    ...
    for step in range(start_iter, max_iter):
        ...
        #     # visualization block
            ...
            imageio.mimsave(f'vis/{step}_{args.type}_gt.gif', render_mesh(mesh_gt.to(args.device)[0], args), fps = 15, loop = 0)
            print(images_gt.shape)
            imageio.imsave(f'vis/{step}_{args.type}_image_gt.png', (feed_dict["images"][0].detach().cpu().numpy()[0, ..., :3] * 255).astype(np.uint8))
